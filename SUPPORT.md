...
Hello, thank you for using DúöScríbî (DuoScribi)! 🙋🏻‍♂️  
...
- Check the [`README`](https://github.com/igorskyflyer/npm-duoscribi/blob/main/README.md) for documentation and setup guidance.
- Search [`issues`](https://github.com/igorskyflyer/npm-duoscribi/issues) to see if your question has already been answered.
...
- open a [`new issue`](https://github.com/igorskyflyer/npm-duoscribi/issues) using the appropriate issue template and with the label of `bug`,
- include details such as:
   - steps to reproduce
   - DúöScríbî (DuoScribi) version
...
Do so by:
- opening a [`new issue`](https://github.com/igorskyflyer/npm-duoscribi/issues) using the appropriate issue template and with the label of `feature`,
...
- See [`CONTRIBUTING.md`](https://github.com/igorskyflyer/npm-duoscribi/blob/main/CONTRIBUTING.md) for guidelines.
...
If you'd like to support further development of DúöScríbî (DuoScribi):
...
<div align="center">
  Thank you for using DúöScríbî (DuoScribi)!
  <br>
